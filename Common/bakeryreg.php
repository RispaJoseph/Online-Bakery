...
<body>
<div style="position:relative;border:groove;left:320px;height:730px;width:900px;top:100px;background-color:white ">
<br>
<form action="" method="post" enctype="multipart/form-data">
<h3 style="position: relative;left:320px;"><font color="black">BAKERY REGISTRATION</font></h3>
...
if($n8==$n9)
{
  $sql="select ifnull(max(bakery_id),0)+1 from bakery_reg";
    $tbl=getDatas($sql);
     $sql="insert into bakery_reg values('$tbl[0][0]','$n1','$n2','$n3','$n4','$n5','$n6','$fname')";
     setDatas($sql);
     $sql="insert into login_reg values('$n4','$n8','bakery','0')";
     setDatas($sql);
